...
func (c *TipoIngresoInversionController) Post() {
	var v models.TipoIngresoInversion
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoIngresoInversion(&v); err == nil {
...
func (c *TipoIngresoInversionController) GetOne() {
	...
	v, err := models.GetTipoIngresoInversionById(id)
	if err != nil {
...
func (c *TipoIngresoInversionController) GetAll() {
	...
	l, err := models.GetAllTipoIngresoInversion(query, fields, sortby, order, offset, limit)
	if err != nil {
...
func (c *TipoIngresoInversionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoIngresoInversion{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTipoIngresoInversionById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "Peticion exitosa", "data": v}
		} else {
...
func (c *TipoIngresoInversionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoIngresoInversion(id); err == nil {
