...
// Post ...
// @Title Post
// @Description create Finanzas
// @Param	body	body	models.Finanzas	true	"body for Finanzas content"
// @Success 201 {int} models.Finanzas
// @Failure 403 body is empty
// @router / [post]
func (c *FinanzasController) Post() {
	var v models.Finanzas
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddFinanzas(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get Finanzas by id
// @Param	id	path	string	true	"The key for staticblock"
// @Success 200 {object} models.Finanzas
// @Failure 403 :id is empty
// @router /:id [get]
func (c *FinanzasController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetFinanzasById(id)
	if err != nil {
...
func (c *FinanzasController) GetAll() {
	...
	l, err := models.GetAllFinanzas(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the Finanzas
...
func (c *FinanzasController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Finanzas{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateFinanzasById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "Peticion exitosa", "data": v}
		} else {
...
// Delete ...
// @Title Delete
// @Description delete the Finanzas
...
func (c *FinanzasController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteFinanzas(id); err == nil {
