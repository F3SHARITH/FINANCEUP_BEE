...
// LeadController operations for Lead
type LeadController struct {
	beego.Controller
}

// URLMapping ...
func (c *LeadController) URLMapping() {
...
// @Param	body		body 	models.Lead	true		"body for Lead content"
// @Success 201 {int} models.Lead
// @Failure 403 body is empty
// @router / [post]
func (c *LeadController) Post() {
	var v models.Lead
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddLead(&v); err == nil {
...
// @router /:id [get]
func (c *LeadController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetLeadById(id)
	if err != nil {
		logs.Error(err)
...
func (c *LeadController) GetAll() {
	...
	l, err := models.GetAllLead(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
// @router /:id [put]
func (c *LeadController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Lead{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateLeadById(&v); err == nil {
			c.Data["json"] = map[string]interface{}{"success": true, "status": 200, "Message": "Peticion exitosa", "data": v}
		} else {
...
// Delete ...
// @Title Delete
// @Description delete the Lead
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *LeadController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteLead(id); err == nil {
