...
// AuditoriaLoginController operations for AuditoriaLogin
type AuditoriaLoginController struct {
	beego.Controller
}

// URLMapping ...
func (c *AuditoriaLoginController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create AuditoriaLogin
// @Param	body		body 	models.AuditoriaLogin	true		"body for AuditoriaLogin content"
// @Success 201 {int} models.AuditoriaLogin
// @Failure 403 body is empty
// @router / [post]
func (c *AuditoriaLoginController) Post() {
	var v models.AuditoriaLogin
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		...
		c.Data["json"] = map[string]interface{}{"success": false, "status": 400, "message": "Error en el formato de la solicitud: " + err.Error()}
	}
	c.ServeJSON()
}
...
// GetOne ...
// @Title Get One
// @Description get AuditoriaLogin by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.AuditoriaLogin
// @Failure 403 :id is empty
// @router /:id [get]
func (c *AuditoriaLoginController) GetOne() {
...
// GetAll ...
// @Title Get All
// @Description get AuditoriaLogin
...
// @Failure 403
// @router / [get]
func (c *AuditoriaLoginController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
// Put ...
// @Title Put
// @Description update the AuditoriaLogin
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.AuditoriaLogin	true		"body for AuditoriaLogin content"
// @Success 200 {object} models.AuditoriaLogin
// @Failure 403 :id is not int
// @router /:id [put]
func (c *AuditoriaLoginController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// Delete ...
// @Title Delete
// @Description delete the AuditoriaLogin
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *AuditoriaLoginController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
